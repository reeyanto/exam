                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table text-center table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $query = "SELECT a.id_santri, GROUP_CONCAT(a.id_kriteria ORDER BY a.id_kriteria ASC) 
                                            as id_kriteria, GROUP_CONCAT(a.nilai_alternatif ORDER BY a.id_kriteria ASC) 
                                            as nilai, b.nama_santri
